 ...
 * @version Dec 16, 2013 11:58:32 AM
 */

public class Login extends AbstractApiCommand implements InitializingBean {
	...
	public ApiResult onExecute(ApiCommandContext context) {
		...
		try {
			...
			us = accountService.login(mobile, password, source);
			McpUtils.rpcTimeCost(t, "accountService.login");
		} catch (Exception e) {
			// 异常记录日志， 返回错误信息
