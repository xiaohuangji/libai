 ...
 * @version Jan 8, 2014 2:49:59 PM
 */

public class GetQRTemplates extends AbstractApiCommand implements InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(GetQRTemplates.class);
    ...
    public ApiResult onExecute(ApiCommandContext context) {
        ...
        try {
            ...
            result = templateService.getQRTemplates(userId);
            McpUtils.rpcTimeCost(t, "templateService.getQRTemplates");
        } catch (Exception e) {
            // 异常记录日志， 返回错误信息
