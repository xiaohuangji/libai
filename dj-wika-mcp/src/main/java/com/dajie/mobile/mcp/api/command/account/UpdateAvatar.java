...
public class UpdateAvatar extends AbstractApiCommand implements
		InitializingBean {
	...
	public ApiResult onExecute(ApiCommandContext context) {
		...
		try {
			...
			result = accountService.updateAvatar(userId, avatar);
			McpUtils.rpcTimeCost(t, "accountService.updateAvatar");
		} catch (Exception e) {
			// 异常记录日志， 返回错误信息
