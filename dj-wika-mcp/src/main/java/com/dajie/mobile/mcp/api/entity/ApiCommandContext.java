/**
 * $Id: ApiCommandContext.java 119964 2012-11-29 09:05:38Z wei.cheng@XIAONEI.OPI.COM $
...
public class ApiCommandContext implements Serializable {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ApiCommandContext.class);
