...
public class GetVerifyCode extends AbstractApiCommand implements InitializingBean {

    private static final Logger logger = LoggerFactory.getLogger(GetVerifyCode.class);
    ...
    public ApiResult onExecute(ApiCommandContext context) {
        ...
        try {
            ...
            result = accountService.getVerifyCode(mobile);
            McpUtils.rpcTimeCost(t, "accountService.getVerifyCode");
        } catch (Exception e) {
            // 异常记录日志， 返回错误信息
