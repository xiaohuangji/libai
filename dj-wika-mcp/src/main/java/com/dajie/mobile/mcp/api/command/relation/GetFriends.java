 ...
 * @version Dec 16, 2013 12:04:46 PM
 */

public class GetFriends extends AbstractApiCommand implements InitializingBean {
	...
	public ApiResult onExecute(ApiCommandContext context) {
		...
		try {
			...
			result = relationService.getFriends(userId);
			McpUtils.rpcTimeCost(t, "relationService.getFriends");
		} catch (Exception e) {
			// 异常记录日志， 返回错误信息
