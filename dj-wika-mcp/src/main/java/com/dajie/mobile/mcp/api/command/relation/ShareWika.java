 ...
 * 
 */
public class ShareWika extends AbstractApiCommand implements InitializingBean {

	private static final Logger logger = LoggerFactory.getLogger(ShareWika.class);
	...
	public ApiResult onExecute(ApiCommandContext context) {
		...
		try {
			...
			result = relationService.shareWika(userId);
			McpUtils.rpcTimeCost(t, "relationService.sharewika");
		} catch (Exception e) {
			// 异常记录日志， 返回错误信息
