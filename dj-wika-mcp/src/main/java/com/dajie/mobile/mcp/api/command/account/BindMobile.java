 ...
 * @version Dec 16, 2013 12:00:36 PM
 */

public class BindMobile extends AbstractApiCommand implements InitializingBean {
    ...
    public ApiResult onExecute(ApiCommandContext context) {
        ...
        try {
            ...
            result = accountService.bindMobile(userId, mobile, verifyCode, password);
            McpUtils.rpcTimeCost(t, "accountService.bindMobile");
        } catch (Exception e) {
            // 异常记录日志， 返回错误信息
