 ...
 */
package com.dajie.mobile.mcp.web.controllers;
...
import com.dajie.mobile.mcp.api.entity.McpResponse;
...
public class CommandController extends AbstractController implements InitializingBean {
    ...
    private static final Logger httpAccessLogger = LoggerFactory.getLogger("mcp_http_access_log");

    private MobileClientAppService mobileClientAppService;

    private PassportService passportService;

    private StringCache<Map<String, Object>, String> sigCache;
    ...
    private boolean validateRequestFrequency(RequestBaseContext requestBaseContext,
        ...
        String sig = requestParamMap.get(HttpConstants.PARAM_SIG);
        try {
        	Map<String, Object> sigCacheKey = new HashMap<String, Object>();
        	sigCacheKey.put("sig", sig);
            String cacheSig = sigCache.get(sigCacheKey);
    ...
    public void setSigCache(StringCache<Map<String, Object>, String> sigCache) {
