...
public class UpdateUserQRCode extends AbstractApiCommand implements
		InitializingBean {
	private static final Logger logger = LoggerFactory
			.getLogger(UpdateUserQRCode.class);
	...
	public ApiResult onExecute(ApiCommandContext context) {
		...
		try {
			...
			result = accountService.updateUserQRCode(userId, faceCodeType, faceQRCode);
			McpUtils.rpcTimeCost(t, "accountService.updateUserQRCode");
		} catch (Exception e) {
			// 异常记录日志， 返回错误信息
