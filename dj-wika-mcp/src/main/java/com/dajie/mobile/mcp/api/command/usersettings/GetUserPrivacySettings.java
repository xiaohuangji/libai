 ...
 * @version Dec 16, 2013 12:07:32 PM
 */

public class GetUserPrivacySettings extends AbstractApiCommand implements
		InitializingBean {

	private static final Logger logger = LoggerFactory
			.getLogger(GetUserPrivacySettings.class);
	...
	public ApiResult onExecute(ApiCommandContext context) {
		...
		try {
			...
			result = userSettingsService.getUserPrivacySettings(userId);
			McpUtils.rpcTimeCost(t, "usersettings.getUserPrivacySettings");
		} catch (Exception e) {
			// 异常记录日志， 返回错误信息
